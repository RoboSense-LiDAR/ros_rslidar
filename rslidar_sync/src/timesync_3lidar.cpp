...
int main(int argc, char** argv)
{
  ...
  {
    ROS_ERROR("Can't get scan3_topic, use the default scan3_topic: %s", scan3_topic.c_str());
  }
  else
  {
    ROS_INFO("scan3_topic: %s", scan3_topic.c_str());
  }
  ...
  {
    ROS_ERROR("Can't get skippackets3_topic, use the default skippackets3_topic: %s", skippackets3_topic.c_str());
  }
  else
  {
    ROS_INFO("skippackets3_topic: %s", skippackets3_topic.c_str());
  }
