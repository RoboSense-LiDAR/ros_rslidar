...
int main(int argc, char **argv)
{
  ...
  message_filters::Subscriber<rslidar_msgs::rslidarScan> scan_sub1(nh, scan1_topic, 1);
  message_filters::Subscriber<rslidar_msgs::rslidarScan> scan_sub2(nh, scan2_topic, 1);
